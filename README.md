...
🎓 Estudiante de Ingeniería de Software, apasionado por el desarrollo backend y la arquitectura de software.  
💻 Me especializo en Java y Spring Boot, creando **APIs robustas y escalables**, con buenas prácticas de desarrollo y arquitectura de microservicios.  
🔐 Experiencia con autenticación JWT y gestión de bases de datos relacionales como PostgreSQL.  
🐳 Manejo básico de contenedores y despliegue con Docker.  
☁️ Interesado en roles de backend para seguir aprendiendo sobre **computación en la nube, desarrollo de software y DevOps**.
